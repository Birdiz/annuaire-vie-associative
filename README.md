...
Ce que l'outil ne fait pas **à votre place**, en revanche, est l'objet de la section suivante.
...
l'[ADR-025](docs/adr/025-regime-juridique-et-obligations.md).
...
l'[ADR-026](docs/adr/026-droit-a-l-effacement.md).
...
- [ADR-025](docs/adr/025-regime-juridique-et-obligations.md) — qui est responsable de traitement,
  et ce que cela vous oblige à faire
- [ADR-026](docs/adr/026-droit-a-l-effacement.md) — comment une opposition est honorée
